...
**Note:** In serverless environments where each invocation runs in isolation, consider Redis or another external cache for cross-process caching.
...
- Any async work that may be called multiple times
