 ...
 */
export const elementFilterColors: Record<string, { selected: string; unselected: string }> = {
  Sun: {
    selected: 'bg-element-sun/30 text-element-sun border-element-sun/50 hover:bg-element-sun/40',
  ...
  Air: {
    selected: 'bg-element-air/30 text-element-air border-element-air/50 hover:bg-element-air/40',
    unselected: 'bg-muted/30 text-foreground border-border hover:bg-muted/50',
  },
  Water: {
    selected:
