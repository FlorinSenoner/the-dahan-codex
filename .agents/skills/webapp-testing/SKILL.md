...
running the script first and find that a customized solution is abslutely necessary. These scripts
...
- **Use bundled scripts as black boxes** - To accomplish a task, consider whether one of the scripts
  available in `scripts/` can help. These scripts handle common, complex workflows reliably without
