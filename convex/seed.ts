  ...
  handler: async (ctx) => {
    ...
    const riverId = await ctx.db.insert("spirits", {
      ...
      presenceTracks: {
        ...
        nodes: [
          ...
          { id: "e2", row: 0, col: 2, value: 2, trackType: "energy" },
          { id: "e3", row: 0, col: 3, value: 3, trackType: "energy" },
          { id: "e4", row: 0, col: 4, value: 4, trackType: "energy" },
          { id: "e5", row: 0, col: 5, value: 4, trackType: "energy" },
          { id: "e6", row: 0, col: 6, value: 5, trackType: "energy" },
          ...
          { id: "c3", row: 1, col: 3, value: 3, trackType: "cardPlays" },
          {
            id: "c4",
            row: 1,
            col: 4,
          ...
          { id: "c6", row: 1, col: 6, value: 5, trackType: "cardPlays" },
        ],
        edges: [],
      },
      innates: [
    ...
    const lightningId = await ctx.db.insert("spirits", {
      ...
      presenceTracks: {
        ...
        nodes: [
          ...
          { id: "e3", row: 0, col: 3, value: 4, trackType: "energy" },
          { id: "e4", row: 0, col: 4, value: 4, trackType: "energy" },
          { id: "e5", row: 0, col: 5, value: 5, trackType: "energy" },
          { id: "e6", row: 0, col: 6, value: 6, trackType: "energy" },
          // Card plays track (row 1) - only 5 slots
          { id: "c0", row: 1, col: 0, value: 1, trackType: "cardPlays" },
          { id: "c1", row: 1, col: 1, value: 2, trackType: "cardPlays" },
          { id: "c2", row: 1, col: 2, value: 2, trackType: "cardPlays" },
          { id: "c3", row: 1, col: 3, value: 3, trackType: "cardPlays" },
          { id: "c4", row: 1, col: 4, value: 4, trackType: "cardPlays" },
        ],
        edges: [],
      },
      innates: [
    ...
    await ctx.db.insert("spirits", {
      ...
      presenceTracks: {
        ...
        nodes: [
          ...
          { id: "c4", row: 1, col: 4, value: 4, trackType: "cardPlays" },
          { id: "c5", row: 1, col: 5, value: 5, trackType: "cardPlays" },
        ],
        edges: [],
      },
      innates: [
    ...
    await ctx.db.insert("spirits", {
      ...
      presenceTracks: {
        ...
        cols: 4,
        nodes: [
          // Energy track (row 0) - unlocks growth
          {
            id: "e0",
            row: 0,
            col: 0,
          ...
          // Card plays track (row 1) - unlocks growth
          {
            id: "c0",
            row: 1,
            col: 0,
          ...
          // Fire/Air track (row 2) - unlocks growth
          {
            id: "fa0",
            row: 2,
            col: 0,
          ...
          // Water/Earth track (row 3) - unlocks growth
          {
            id: "we0",
            row: 3,
            col: 0,
    ...
    await ctx.db.insert("spirits", {
      ...
      presenceTracks: {
        ...
        cols: 8,
        nodes: [
          // Energy track (row 0) - from actual spirit panel
          { id: "e0", row: 0, col: 0, value: 1, trackType: "energy" },
          {
            id: "e1",
            row: 0,
          ...
          { id: "e3", row: 0, col: 3, trackType: "special", reclaim: true },
          // e4 (col 4) is covered on panel - skip
          { id: "e5", row: 0, col: 5, value: 6, trackType: "energy" },
          {
            id: "e6",
            row: 0,
            col: 6,
          ...
          { id: "e7", row: 0, col: 7, value: 12, trackType: "energy" },
          // Card Plays track (row 1) - from actual spirit panel
          { id: "c0", row: 1, col: 0, value: 1, trackType: "cardPlays" },
          {
            id: "c1",
            row: 1,
          ...
          // Deep Slumber track (row 2) - presence cap: 5, 7, 8, 10, 11, 12, 13 (skips 6 and 9)
          {
            id: "d0",
            row: 2,
            col: 0,
            trackLabel: "Deep Slumber",
            value: 5,
            trackType: "special",
            presenceCap: 5,
          },
