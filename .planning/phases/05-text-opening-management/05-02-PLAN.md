...
4. Filter spirits client-side using useMemo:
   ```typescript
...
7. Show result count when search is active:
  ...
  <verify>pnpm dev - search works, URL shows ?search=term, filtering is instant</verify>
  <done>Search filters spirits by name/summary/description with URL persistence</done>
</task>
