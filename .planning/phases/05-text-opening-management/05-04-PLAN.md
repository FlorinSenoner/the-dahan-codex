...
Note: Keep the existing display logic for non-edit mode. The edit UI should layer on top.
  ...
  <verify>pnpm typecheck passes, pnpm dev shows edit mode toggle working, no difficulty badge visible</verify>
  <done>OpeningSection shows editable UI for admins in edit mode, difficulty UI removed</done>
</task>
